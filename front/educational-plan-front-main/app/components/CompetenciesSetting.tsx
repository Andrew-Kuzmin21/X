...
export const CompetenciesSetting = ({
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const groupsResponse = await fetch('http://localhost:8000/competency-groups/');
                ...
                const compResponse = await fetch('http://localhost:8000/competencies/');
    ...
    useEffect(() => {
        ...
        const fetchGroupName = async () => {
            try {
                const response = await fetch(`http://localhost:8000/competency-groups/${currentCompetence.competency_group_id}/`);
