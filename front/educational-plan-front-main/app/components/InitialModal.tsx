...
export const InitialModal = ({
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const dirResponse = await fetch('http://localhost:8000/directions/');
        ...
        if (mode === "open" && selectedDirection) {
            try {
                ...
                const response = await fetch(
                    `http://localhost:8000/directions/${selectedDirection.id}/maps/unload`
                );
    ...
    const handleCreateDirection = async () => {
        ...
        try {
            const response = await fetch('http://localhost:8000/directions/', {
                method: 'POST',
            ...
            const updatedRes = await fetch('http://localhost:8000/directions/?expand=educational_level,educational_form');
            if (updatedRes.ok) {
